...
// x
const open_consent_screen_4 = __importDefault(require("./x/open_consent_screen"));
const get_accesstoken_4 = __importDefault(require("./x/get_accesstoken"));
const get_user_4 = __importDefault(require("./x/get_user"));
const get_user2_4 = __importDefault(require("./x/get_user2"));
class Oauth {
    constructor() {
        this.google = {
